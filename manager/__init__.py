...
form={
    ...
    'QUERY_SEARCH_TABLES':[
            ...
            {'t':'manager_position','a':'pos','l':'wt.position=pos.id','lj':1,'for_fields':['position','bank_percent']},
    ...
    'cols':[
            [ # Колонка1
              ...
              {'description':'KPI','name':'kpi','hide':0},
            ],
            [
              {'description':'Начисления','name':'bank','hide':1},
