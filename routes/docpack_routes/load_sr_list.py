        ...
        if app:
            ...
            if t==1:
                ...
                query=f"""
                        ...
                        WHERE wt.user_id=%s and (a.id is null or s.type<>1) and wt.born >= (curdate() - interval 12 month)
                """
                ...
                query=f"""
                        SELECT
                            wt.id id,if(wt.regnumber, wt.regnumber,'-') v, date(wt.born) from_date, '' comment,
